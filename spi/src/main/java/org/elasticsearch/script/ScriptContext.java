 ...
 * class must have an abstract method named {@code execute} which ScriptEngine implementations
 * will define.
 * <p>
 * The <i>FactoryType</i> is a factory class returned by the ScriptService when compiling
 ...
 * stateless factory type required by the ScriptService. If defined, the <i>StatefulFactoryType</i>
