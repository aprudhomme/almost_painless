...
public final class CompilerSettings {
     ...
     */
    public static final String REGEX_ENABLED = "regex_enabled";
    public static final RegexEnabled DEFAULT_REGEX_ENABLED = RegexEnabled.LIMITED;
     ...
     */
    public static final String REGEX_LIMIT_FACTOR = "regex_limit_factor";
    public static final int DEFAULT_REGEX_LIMIT_FACTOR = 6;
